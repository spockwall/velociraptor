...
use zmq_server::setup::{
    add_binance, add_binance_spot, add_coinbase, add_hyperliquid, add_okx, attach_recorder,
    attach_redis, attach_zmq, build_system, spawn_kalshi_schedulers, spawn_polymarket_schedulers,
